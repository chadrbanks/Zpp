...
class ZppViewImplementation extends ZppViewHTML
{
	...
	function content( $args = array() )
    {
		...
		// This is an example page using Bootstrap
        $this -> head_content[ ] ='<meta charset="utf-8">';
        $this -> head_content[ ] ='<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">';
...
.mastfoot {
  color: rgba(255, 255, 255, .5);
        ...
        $this -> body_content[ ] ='<div class="cover-container d-flex h-100 p-3 mx-auto flex-column">
